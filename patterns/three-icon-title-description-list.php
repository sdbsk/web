...
/**
 * Title: 3 x ikona, nadpis a odkaz ako zoznam
 * Description: Kartička má naľavo šedí pásik
 * Slug: saleziani/three-icon-heading-description-list
...
<div class="wp-block-group wp-pattern-saleziani-three-icon-heading-description">
    ...
    <div class="wp-block-group row g-4 gy-5 row-cols-1 row-cols-sm-2 row-cols-md-3">
        ...
        <div class="wp-block-group col">
            ...
            <div class="box wp-block-group">
                ...
                <!-- /wp:heading -->
                <!-- wp:paragraph -->
                <p>Nam vel tristique massa, ac malesuada urna. Morbi ultrices ullamcorper leo quis maximus. Nam aliquam
                    bibendum risus a porttitor. Etiam elit libero.</p>
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
        ...
        <div class="wp-block-group col">
            ...
            <div class="box wp-block-group">
                ...
                <!-- /wp:heading -->
                <!-- wp:paragraph -->
                <p>Integer a turpis fermentum lorem ornare dictum. Nam porta nisl eget neque auctor, non facilisis dolor
                    placerat. Cras in posuere purus, id faucibus urna.</p>
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
                <p><a href="#">Dozvedieť viac</a></p>
                <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group col">
            ...
            <div class="box wp-block-group">
                ...
                <!-- /wp:heading -->
                <!-- wp:paragraph -->
                <p>In blandit mi tempor, laoreet turpis eu, volutpat ante. Suspendisse fringilla cursus semper. Ut quis
                    iaculis nisl.</p>
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
                <p><a href="#">Dozvedieť viac</a></p>
