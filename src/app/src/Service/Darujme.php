...
readonly class Darujme
{
    public function __construct(
        private DarujmeApi                $darujmeApi,
        private DarujmeCampaignRepository $darujmeCampaignRepository,
    ...
    public function execute(?SymfonyStyle $console = null): void
    {
        $campaigns = [];
